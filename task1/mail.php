...
if(isset($_POST["submit"]))
{
 ...
 if($error == '')
 {
  ...
  $mail = new PHPMailer;
  $mail->smtp;        //Sets Mailer to send message using SMTP
  $mail->Host = 'smtp.gmail.com';  //Sets the SMTP hosts
  $mail->Port = '587';        //Sets the default SMTP server port
  $mail->SMTPAuth = true;       //Sets SMTP authentication. Utilizes the Username and Password variables
  $mail->Username = 'crazydev82@gmail.com';    //Sets SMTP username
  $mail->Password = 'mitul123';     //Sets SMTP password
  $mail->SMTPSecure = '';       //Sets connection prefix. Options are "", "ssl" or "tls"
  $mail->From = $_POST["crazydev82@gmail.com"];     //Sets the From email address for the message
  $mail->FromName = $_POST["task1"];    //Sets the From name of the message
